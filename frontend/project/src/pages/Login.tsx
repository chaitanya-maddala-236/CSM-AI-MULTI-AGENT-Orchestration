    ...
    <div className="min-h-screen flex bg-white dark:bg-gray-950">
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-slate-50 dark:bg-gray-950">
        <motion.div
          ...
          {/* Demo Credentials */}
          <motion.div
            className="bg-blue-50 dark:bg-blue-950/50 border border-blue-100 dark:border-blue-900 rounded-2xl p-4 mb-6"
            ...
            <div className="space-y-1 text-xs text-blue-600 dark:text-blue-400 font-mono bg-white dark:bg-blue-950/80 rounded-xl p-2.5 border border-blue-100 dark:border-blue-900">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-slate-200 dark:border-gray-700 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-900 dark:text-slate-100 transition-all"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pr-11 border border-slate-200 dark:border-gray-700 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-900 dark:text-slate-100 transition-all"
                  placeholder="••••••••"
                />
